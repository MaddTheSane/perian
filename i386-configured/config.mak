...
STRIP=strip -x
INSTALLSTRIP=
OPTFLAGS=-O3 -g  -no-cpp-precomp -pipe -fomit-frame-pointer -force_cpusubtype_ALL -Wno-sign-compare -Wdeclaration-after-statement -Wall -Wno-switch -mdynamic-no-pic
SHCFLAGS=-O3 -g  -no-cpp-precomp -pipe -fomit-frame-pointer -force_cpusubtype_ALL -Wno-sign-compare -Wdeclaration-after-statement -Wall -Wno-switch
