...
STRIP=strip -x
INSTALLSTRIP=
OPTFLAGS=-O3 -g  -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -no-cpp-precomp -pipe -fomit-frame-pointer -force_cpusubtype_ALL -Wno-sign-compare -Wdeclaration-after-statement -Wall -Wno-switch -mdynamic-no-pic
SHCFLAGS=-O3 -g  -arch i386 -isysroot /Developer/SDKs/MacOSX10.4u.sdk -no-cpp-precomp -pipe -fomit-frame-pointer -force_cpusubtype_ALL -Wno-sign-compare -Wdeclaration-after-statement -Wall -Wno-switch
LDFLAGS=-Wl,-dynamic,-search_paths_first -isysroot /Developer/SDKs/MacOSX10.4u.sdk -arch i386 
LDCONFIG=ldconfig
